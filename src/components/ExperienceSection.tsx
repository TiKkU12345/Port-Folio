...
const journey: RouteStop[] = [
  {
    ...
    description: 'Developing AI-powered applications using Python, FastAPI, and LLMs. Building RAG pipelines with embeddings and vector databases for document-based question answering, while integrating REST APIs and collaborating through Git/GitHub.',
  },
  {
    id: '03',
    year: '2026',
    title: 'CHAIN SCOPE AI',
    organization: 'MANTLE TURING TEST HACKATHON',
    description: 'Built an LLM-powered smart contract analysis platform with automated risk assessment and AI-generated audit insights as a hackathon project.',
  },
  {
    id: '04',
    year: '2023 - 2026',
    title: 'BACHELOR OF COMPUTER APPLICATIONS',
    organization: 'GD RUNGTA COLLEGE OF SCIENCE & TECHNOLOGY',
    description: 'Graduated with a BCA and focused coursework in Data Structures & Algorithms, Database Management Systems, Machine Learning, and AI/ML. CGPA: 6.82/10.',
  },
];
